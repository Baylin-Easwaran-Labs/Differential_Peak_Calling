...
handler = logging.FileHandler('K4_log')
...
def MainStatistics(ac, peak_output1, peak_output2,con1_name, con2_name, output_file_name, foldername, expected_number_for_chi_square):
    ...
    #SaveDFtoCSV('K4_intermediate_data',output_file_name, final_df_Pvalues)
    #path = 'K4_intermediate_data/'+ output_file_name
...
if __name__ == '__main__':
    ...
    ##############################################################
    folder_name_peakcall = 'MACS2_bdgpeakcall_files'

    fpeak_out_1 = 'Galaxy1739-[Mock_K4_Qnorm_bdgpeakcall_1500_300].txt'
    fpeak_out_2 = 'Galaxy1740-[455_K4_Qnorm_bdgpeakcall_1500_300].txt'
    fpeak_out_3 = 'Galaxy1741-[DAC_K4_Qnorm_bdgpeakcall_1500_300].txt'
    fpeak_out_4 = 'Galaxy1742-[DAC455_K4_Qnorm_bdgpeakcall_1500_300].txt'
    
    ##############################################################
    folder_name = 'MACS2_bdgdiff_bedgraph_input_files'

    file1_1 = 'Galaxy1075-[Mock_K4_Qnorm_Final].bedgraph'
    file1_2 = 'Galaxy1076-[455_K4_Qnorm_Final].bedgraph'
    file1_3 = 'Galaxy1078-[DAC_K4_Qnorm_final].bedgraph'
    file1_4 = 'Galaxy1077-[DAC455_K4_Qnorm_Final].bedgraph'
    ...
    #SaveDFtoPickle('outputK4', 'peak_output1', peak_output1)
    #SaveDFtoPickle('outputK4', 'peak_output2', peak_output2)
    #SaveDFtoPickle('outputK4', 'peak_output3', peak_output3)
    #SaveDFtoPickle('outputK4', 'peak_output4', peak_output4)
    ...
    #SaveDFtoPickle('outputK4', 'output1', output1)
    #SaveDFtoPickle('outputK4', 'output2', output2)
    #SaveDFtoPickle('outputK4', 'output3', output3)
    #SaveDFtoPickle('outputK4', 'output4', output4)
    
    #peak_output1 = pd.read_pickle('outputK4/peak_output1')
    #peak_output2 = pd.read_pickle('outputK4/peak_output2')
    #peak_output3 = pd.read_pickle('outputK4/peak_output3')
    #peak_output4 = pd.read_pickle('outputK4/peak_output4')
    #output1 = pd.read_pickle('outputK4/output1')
    #output2 = pd.read_pickle('outputK4/output2')
    #output3 = pd.read_pickle('outputK4/output3')
    #output4 = pd.read_pickle('outputK4/output4')
    #output1 = []
    #output2 = []
    #output3 = []
    #output4 = []
    ...
    logger.info('Start 1')
    print('Start_1')
    AfterInputsProcessing(peak_output1, peak_output2, output1, output2,'Mock_k4', '455_K4', '455_K4_vs_Mock_k4.csv', '455_K4_vs_Mock_k4')
    logger.info('Start 2')
    print('Start_2')
    AfterInputsProcessing(peak_output1, peak_output3, output1, output3,'Mock_k4', 'DAC_K4', 'DAC_K4_vs_mock_k4.csv', 'DAC_K4_vs_mock_k4')
    logger.info('Start 3')
    print('Start_3')
    AfterInputsProcessing(peak_output1, peak_output4, output1, output4,'Mock_k4', 'DAC455_k4', 'DAC455_k4_vs_mock_K4.csv', 'DAC455_k4_vs_mock_K4')
    logger.info('Start 4')
    print('Start_4')
    AfterInputsProcessing(peak_output3, peak_output4, output3, output4,'DAC_k4', 'DAC455_k4', 'DAC455_k4_vs_DAC_k4.csv', 'DAC455_k4_vs_DAC_k4')
    logger.info('Start 5')
    print('Start_5')
    AfterInputsProcessing(peak_output2, peak_output4, output2, output4,'455_K4', 'DAC455_k4', 'DAC455_k4_vs_455_K4.csv', 'DAC455_k4_vs_455_K4')
